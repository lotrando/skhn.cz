                ...
                <div class="row">
                  <div class="col-xl-4 d-flex align-items-stretch">
                    <div class="icon-box mt-xl-0 my-4">
                      ...
                      <h4>Rozvoj</h4>
                      <p>Jsme si vědomi, že právě vaši zaměstnanci, se svými znalostmi a dovednostmi, jsou
                        hlavním pilířem úspěchu vaší lékárny.</p>
                  ...
                  <div class="col-xl-4 d-flex align-items-stretch">
                    <div class="icon-box mt-xl-0 my-4">
                      ...
                      <p>Poskytneme vám plnohodnotnou marketingovou podporu. Nastavíme vám systém dlouhodobého formování
                        a podpory vztahu s potenciálním zákazníkem pomocí obsahu, který pomáhá, vzdělává a baví.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-lg-0 mt-4">
              <div class="icon-box">
                ...
                <p>Poznáváte se v některé z uvedených situací? Pak právě vám nabízíme řešení, jak zlikvidovat tyto
                  konkurenční nevýhody! Díky koordinovanému postupu, který vám Sdružení Karvinské hornické
                  nemocnice (SKHN) nabízí, získáte až stoprocentní bonusový nárůst. To vám garantujeme, protože jsme
                  orientováni na obchodní výsledek svých klientů.
                </p>
                </p>
              </div>
            </div>
